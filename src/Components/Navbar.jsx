...
const Navbar = ({ active, setActive }) => {
  return (
    <nav className="p-1">
      <div className="w-full flex gap-4 bg-[#18212b] rounded-md p-1">
        <div
          onClick={() => setActive("projects")}
          className={`w-1/3 p-1 text-center cursor-pointer font-bold rounded-lg transition-all duration-500 ${
