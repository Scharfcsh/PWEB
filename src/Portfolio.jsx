  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#e5e5e5] font-mono selection:bg-emerald-500/20 selection:text-emerald-200">
      <div className="max-w-3xl mx-auto px-6 py-20 md:py-32">
        ...
        >
          {/* Hero */}
          <motion.header variants={fadeIn} className="space-y-6 text-center">
            <div className="flex items-center justify-center gap-3 text-sm">
              <LiveDot />
              <span className="text-emerald-500/70 text-xs tracking-wide">
          ...
          {/* Tech Stack */}
          <motion.section variants={fadeIn} className="space-y-6 text-center">
            <h2 className="text-[#555] text-xs uppercase tracking-widest flex items-center justify-center gap-2">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {techStack.map((tech, i) => (
                <motion.span
                  ...
                  className="text-[#888] text-sm px-3 py-1.5 bg-[#111] border border-[#1a1a1a] rounded-md hover:border-emerald-500/30 hover:text-emerald-400/80 transition-all duration-200"
                >
                  {tech}
                </motion.span>
              ))}
          ...
          {/* AMS Labs - Featured Venture */}
          <motion.section variants={fadeIn} className="space-y-6 text-center">
            <h2 className="text-[#555] text-xs uppercase tracking-widest flex items-center justify-center gap-2">
              <span>{Icons.terminal}</span>
              Studio Labs
              <span className="text-emerald-500/70 text-[10px] ml-2 px-2 py-0.5 bg-emerald-500/10 rounded-full">
                Active
              </span>
            </h2>
            <motion.div
              whileHover={{ scale: 1.01 }}
              className="p-6 rounded bg-gradient-to-br from-[#111] to-[#0d0d0d] border border-emerald-100/20 hover:border-emerald-200/40 transition-all duration-300 text-left"
            >
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h3 className="text-2xl font-semibold text-[#e5e5e5] mb-1">
                    {amsLabs.name}
                  </h3>
                ...
                <a
                  ...
                  className="flex items-center gap-2 px-4 py-2 text-sm text-emerald-400/80 bg-emerald-500/10 rounded-lg border border-emerald-500/20 hover:bg-emerald-500/20 hover:border-emerald-500/40 transition-all duration-200"
                >
                  Visit {Icons.arrow}
                </a>
              </div>
              ...
              <ul className="space-y-2">
                {amsLabs.highlights.map((highlight, i) => (
                  ...
                  >
                    <span className="w-1.5 h-1.5 bg-emerald-500/60 rounded-full"></span>
                    {highlight}
                  </li>
                ))}
              </ul>
          ...
          {/* Professional Work */}
          <motion.section variants={fadeIn} className="space-y-8 text-center">
            <h2 className="text-[#555] text-xs uppercase tracking-widest flex items-center justify-center gap-2">
              <span>{Icons.file}</span>
              Professional Work
              <span className="text-emerald-500/50 text-[10px] ml-2">
                Production
              </span>
            </h2>
            <div className="space-y-6 text-left">
              {professionalWork.map((project, i) => (
                <motion.div
                  ...
                  className={`group p-4 -mx-4 rounded-lg hover:bg-[#111] transition-colors duration-300 ${project.highlight ? "border border-emerald-500/20" : ""}`}
                >
          ...
          >
            <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:justify-between text-[#444] text-xs">
              <p>
